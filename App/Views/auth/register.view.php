...
<div class="w-full max-w-xs mx-auto pt-6">
  ...
  <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    <div class="border-b mb-6">
      <h2 class="text-gray-700 text-xl uppercase font-bold">Register</h2>
    </div>
    <form name="register" action="/PHP-Auth/auth/register" method="POST" onsubmit="registerForm()">
      <?php
    ...
    <div class="mb-4">
      ...
      <div class="mb-4">
        ...
        <input
          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-blue-400"
          type="email" placeholder="example@mail.com" name="email">
        <p class="text-red-500 text-xs italic"></p>
      </div>
      ...
      <div class="flex items-center justify-between">
        ...
        <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="/PHP-Auth/auth/login">
          Already Registered?
        </a>
      </div>
    </form>
